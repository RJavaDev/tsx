...
INSERT INTO tsx_add_group(status, created_date, name_en, name_ru, name_uz, category_id, type)
VALUES
    ('CREATED', NOW(), 'Kind of work*', 'Тип работы*', 'Ish turi* 1', function_getid('Работа розничная торговля / Продажи'), 0),
    ('CREATED', NOW(), 'Employment type*', 'Тип занятости*', 'Bandlik turi* 1', function_getid('Работа розничная торговля / Продажи'), 0),
    ('CREATED', NOW(), 'Link to resume submission form', 'Ссылка на форму подачи резюме', 'Taqdim etish shaklini davom ettirish uchun havola 1', function_getid('Работа розничная торговля / Продажи'), 0),
    ('CREATED', NOW(), 'Kind of work*', 'Тип работы*', 'Ish turi* 2', function_getid('Работа транспорт / логистика'), 0),
    ('CREATED', NOW(), 'Employment type*', 'Тип занятости*', 'Bandlik turi* 2', function_getid('Работа транспорт / логистика'), 0),
    ('CREATED', NOW(), 'Link to resume submission form', 'Ссылка на форму подачи резюме', 'Taqdim etish shaklini davom ettirish uchun havola 2', function_getid('Работа транспорт / логистика'), 0),
    ('CREATED', NOW(), 'Kind of work*', 'Тип работы*', 'Ish turi* 3', function_getid('Работа строительство'), 0),
    ('CREATED', NOW(), 'Employment type*', 'Тип занятости*', 'Bandlik turi* 3', function_getid('Работа строительство'), 0),
    ('CREATED', NOW(), 'Link to resume submission form', 'Ссылка на форму подачи резюме', 'Taqdim etish shaklini davom ettirish uchun havola 3', function_getid('Работа строительство'), 0),
    ('CREATED', NOW(), 'Kind of work*', 'Тип работы*', 'Ish turi* 4', function_getid('Работа юриспруденция и бухгалтерия'), 0),
    ('CREATED', NOW(), 'Employment type*', 'Тип занятости*', 'Bandlik turi* 4', function_getid('Работа юриспруденция и бухгалтерия'), 0),
    ('CREATED', NOW(), 'Link to resume submission form', 'Ссылка на форму подачи резюме', 'Taqdim etish shaklini davom ettirish uchun havola 4', function_getid('Работа юриспруденция и бухгалтерия'), 0),
    ('CREATED', NOW(), 'Kind of work*', 'Тип работы*', 'Ish turi* 5', function_getid('Работа охрана / безопасность'), 0),
    ('CREATED', NOW(), 'Employment type*', 'Тип занятости*', 'Bandlik turi* 5', function_getid('Работа охрана / безопасность'), 0),
    ('CREATED', NOW(), 'Link to resume submission form', 'Ссылка на форму подачи резюме', 'Taqdim etish shaklini davom ettirish uchun havola 5', function_getid('Работа охрана / безопасность'), 0),
    ('CREATED', NOW(), 'Kind of work*', 'Тип работы*', 'Ish turi* 6', function_getid('Работа домашний персонал'), 0),
    ('CREATED', NOW(), 'Employment type*', 'Тип занятости*', 'Bandlik turi* 6', function_getid('Работа домашний персонал'), 0),
    ('CREATED', NOW(), 'Link to resume submission form', 'Ссылка на форму подачи резюме', 'Taqdim etish shaklini davom ettirish uchun havola 6', function_getid('Работа домашний персонал'), 0),
    ('CREATED', NOW(), 'Kind of work*', 'Тип работы*', 'Ish turi* 7', function_getid('Работа красота / фитнес / спорт'), 0),
    ('CREATED', NOW(), 'Employment type*', 'Тип занятости*', 'Bandlik turi* 7', function_getid('Работа красота / фитнес / спорт'), 0),
    ('CREATED', NOW(), 'Link to resume submission form', 'Ссылка на форму подачи резюме', 'Taqdim etish shaklini davom ettirish uchun havola 7', function_getid('Работа красота / фитнес / спорт'), 0),
    ('CREATED', NOW(), 'Kind of work*', 'Тип работы*', 'Ish turi* 8', function_getid('Работа туризм / отдых / развлечения'), 0),
    ('CREATED', NOW(), 'Employment type*', 'Тип занятости*', 'Bandlik turi* 8', function_getid('Работа туризм / отдых / развлечения'), 0),
    ('CREATED', NOW(), 'Link to resume submission form', 'Ссылка на форму подачи резюме', 'Taqdim etish shaklini davom ettirish uchun havola 8', function_getid('Работа туризм / отдых / развлечения'), 0),
    ('CREATED', NOW(), 'Kind of work*', 'Тип работы*', 'Ish turi* 9', function_getid('Работа образование'), 0),
    ('CREATED', NOW(), 'Employment type*', 'Тип занятости*', 'Bandlik turi* 9', function_getid('Работа образование'), 0),
    ('CREATED', NOW(), 'Link to resume submission form', 'Ссылка на форму подачи резюме', 'Taqdim etish shaklini davom ettirish uchun havola 9', function_getid('Работа образование'), 0),
    ('CREATED', NOW(), 'Kind of work*', 'Тип работы*', 'Ish turi* 10', function_getid('Работа культура / искусство'), 0),
    ('CREATED', NOW(), 'Employment type*', 'Тип занятости*', 'Bandlik turi* 10', function_getid('Работа культура / искусство'), 0),
    ('CREATED', NOW(), 'Link to resume submission form', 'Ссылка на форму подачи резюме', 'Taqdim etish shaklini davom ettirish uchun havola 10', function_getid('Работа культура / искусство'), 0),
    ('CREATED', NOW(), 'Kind of work*', 'Тип работы*', 'Ish turi* 11', function_getid('Работа медицина / фармация'), 0),
    ('CREATED', NOW(), 'Employment type*', 'Тип занятости*', 'Bandlik turi* 11', function_getid('Работа медицина / фармация'), 0),
    ('CREATED', NOW(), 'Link to resume submission form', 'Ссылка на форму подачи резюме', 'Taqdim etish shaklini davom ettirish uchun havola 11', function_getid('Работа медицина / фармация'), 0),
    ('CREATED', NOW(), 'Kind of work*', 'Тип работы*', 'Ish turi* 12', function_getid('Работа "IТ" / телеком / компьютеры'), 0),
    ('CREATED', NOW(), 'Employment type*', 'Тип занятости*', 'Bandlik turi* 12', function_getid('Работа "IТ" / телеком / компьютеры'), 0),
    ('CREATED', NOW(), 'Link to resume submission form', 'Ссылка на форму подачи резюме', 'Taqdim etish shaklini davom ettirish uchun havola 12', function_getid('Работа "IТ" / телеком / компьютеры'), 0),
    ('CREATED', NOW(), 'Kind of work*', 'Тип работы*', 'Ish turi* 13', function_getid('Работа недвижимость'), 0),
    ('CREATED', NOW(), 'Employment type*', 'Тип занятости*', 'Bandlik turi* 13', function_getid('Работа недвижимость'), 0),
    ('CREATED', NOW(), 'Link to resume submission form', 'Ссылка на форму подачи резюме', 'Taqdim etish shaklini davom ettirish uchun havola 13', function_getid('Работа недвижимость'), 0),
    ('CREATED', NOW(), 'Kind of work*', 'Тип работы*', 'Ish turi* 14', function_getid('Работа маркетинг / реклама / дизайн'), 0),
    ('CREATED', NOW(), 'Employment type*', 'Тип занятости*', 'Bandlik turi* 14', function_getid('Работа маркетинг / реклама / дизайн'), 0),
    ('CREATED', NOW(), 'Link to resume submission form', 'Ссылка на форму подачи резюме', 'Taqdim etish shaklini davom ettirish uchun havola 14', function_getid('Работа маркетинг / реклама / дизайн'), 0),
    ('CREATED', NOW(), 'Kind of work*', 'Тип работы*', 'Ish turi* 15', function_getid('Работа производство / энергетика'), 0),
    ('CREATED', NOW(), 'Employment type*', 'Тип занятости*', 'Bandlik turi* 15', function_getid('Работа производство / энергетика'), 0),
    ('CREATED', NOW(), 'Link to resume submission form', 'Ссылка на форму подачи резюме', 'Taqdim etish shaklini davom ettirish uchun havola 15', function_getid('Работа производство / энергетика'), 0),
    ('CREATED', NOW(), 'Kind of work*', 'Тип работы*', 'Ish turi* 16', function_getid('Работа секретариат / АХО'), 0),
    ('CREATED', NOW(), 'Employment type*', 'Тип занятости*', 'Bandlik turi* 16', function_getid('Работа секретариат / АХО'), 0),
    ('CREATED', NOW(), 'Link to resume submission form', 'Ссылка на форму подачи резюме', 'Taqdim etish shaklini davom ettirish uchun havola 16', function_getid('Работа секретариат / АХО'), 0),
    ('CREATED', NOW(), 'Kind of work*', 'Тип работы*', 'Ish turi* 17', function_getid('Работа начало карьеры / Студенты'), 0),
    ('CREATED', NOW(), 'Employment type*', 'Тип занятости*', 'Bandlik turi* 17', function_getid('Работа начало карьеры / Студенты'), 0),
    ('CREATED', NOW(), 'Link to resume submission form', 'Ссылка на форму подачи резюме', 'Taqdim etish shaklini davom ettirish uchun havola 17', function_getid('Работа начало карьеры / Студенты'), 0),
    ('CREATED', NOW(), 'Kind of work*', 'Тип работы*', 'Ish turi* 18', function_getid('Работа сервис и быт'), 0),
    ('CREATED', NOW(), 'Employment type*', 'Тип занятости*', 'Bandlik turi* 18', function_getid('Работа сервис и быт'), 0),
    ('CREATED', NOW(), 'Link to resume submission form', 'Ссылка на форму подачи резюме', 'Taqdim etish shaklini davom ettirish uchun havola 18', function_getid('Работа сервис и быт'), 0),
    ('CREATED', NOW(), 'Kind of work*', 'Тип работы*', 'Ish turi* 19', function_getid('Работа другие сферы занятий'), 0),
    ('CREATED', NOW(), 'Employment type*', 'Тип занятости*', 'Bandlik turi* 19', function_getid('Работа другие сферы занятий'), 0),
    ('CREATED', NOW(), 'Link to resume submission form', 'Ссылка на форму подачи резюме', 'Taqdim etish shaklini davom ettirish uchun havola 19', function_getid('Работа другие сферы занятий'), 0),
